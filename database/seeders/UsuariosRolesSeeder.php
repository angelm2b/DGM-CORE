...
class UsuariosRolesSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permisos = [
            ...
            'expedientes.ver' => 'Consultar expedientes',
            ...
            'adjuntos.validar' => 'Validar adjuntos',
            ...
            'documentos.ver' => 'Consultar documentos emitidos',
            'documentos.revocar' => 'Revocar documentos',
            'documentos.reponer' => 'Reponer documentos',
        ...
        $roles = [
            ...
            'ANALISTA_EXTRANJERIA' => ['nombre' => 'Analista de Extranjería', 'permisos' => collect([
                'personas.crear', 'personas.ver', 'personas.actualizar', 'expedientes.ver',
                'solicitudes.crear', 'solicitudes.ver', 'solicitudes.transicionar',
                'adjuntos.cargar', 'adjuntos.validar', 'adjuntos.eliminar',
                'ordenes.ver', 'pagos.ver',
                'documentos.emitir', 'documentos.ver', 'documentos.revocar', 'documentos.reponer',
                'documentos.verificar', 'calculos.ver', 'catalogos.ver',
            ])],
