...
<head>
    ...
    <style>
        ...
        /* Oculta la marca "Powered by Stoplight". */
        a[href*="stoplight.io"] { display: none !important; }
        /* Botón flotante para cerrar la sesión de acceso a la documentación. */
        .dgm-salir {
            position: fixed;
            top: 12px;
            right: 16px;
        ...
        .dgm-salir:hover { background: #1e293b; }
...
<a class="dgm-salir" href="/docs-acceso/salir">← Salir</a>
<elements-api
    id="docs"
