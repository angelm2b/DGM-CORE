...
use App\Http\Middleware\AccesoDocumentacion;
...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'API interna del CORE de la DGM. Consumida exclusivamente por el Sistema de Integración (cliente "integrador") mediante token Sanctum (Bearer). Todas las rutas viven bajo el prefijo /core/v1.',
    ],

    'ui' => [
        'title' => 'DGM CORE — API interna',
    ],
